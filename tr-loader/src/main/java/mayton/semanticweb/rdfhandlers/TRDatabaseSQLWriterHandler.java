...
public class TRDatabaseSQLWriterHandler extends TRTable implements RDFHandler, Trackable {
    ...
    public TRDatabaseSQLWriterHandler(Map<IRI, Pair<String, String>> predicates, PrintWriter pw, String tableName) {
        super(tableName);
