package mayton.kafka.serde.avro.reflection;
...
public class GeoIpReflectionProducer {


    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(GeoIpReflectionProducer.class);
        logger.info("Start");
        ...
        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "mayton.kafka.serde.avro.AvroGenericRecordDeserializer");
