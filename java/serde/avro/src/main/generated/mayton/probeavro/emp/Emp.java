...
public class Emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8831128166187644155L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Emp\",\"namespace\":\"mayton.probeavro.emp\",\"doc\":\"Employee table\",\"fields\":[{\"name\":\"ID\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public Emp(java.lang.Integer ID, java.lang.CharSequence name) {
    this.ID = ID;
    this.name = name;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Emp>
    ...
    /**
      ...
      * @return This builder.
      */
    public mayton.probeavro.emp.Emp.Builder setID(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mayton.probeavro.emp.Emp.Builder clearID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public mayton.probeavro.emp.Emp.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mayton.probeavro.emp.Emp.Builder clearName() {
      name = null;
