...
public class MarkoffChainAnalyzer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new YamlSerializer().serialize(graph, new FileOutputStream("war-and-society-1-2-3-4.yaml"));

        Properties properties = new Properties();
        properties.put("limit", Integer.valueOf(args[0]));
        new GraphVizSerializer().serialize(graph, new FileOutputStream("war-and-society-1-2-3-4.dot"),properties);
